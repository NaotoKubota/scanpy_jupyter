...
## tags and links
- `1.2` [(master/Dockerfile)](https://github.com/NaotoKubota/scanpy_jupyter/blob/master/Dockerfile)

## how to build

```sh
docker pull naotokubota/scanpy_jupyter:1.2
```
...
cd scanpy_jupyter
docker build --rm -t naotokubota/scanpy_jupyter:1.2 .
```

## running

```sh
docker run --rm -v `pwd`:/home/jovyan/work -p 10000:8888 naotokubota/scanpy_jupyter:1.2
```
